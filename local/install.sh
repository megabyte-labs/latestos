...
# @description This script will install LatestOS. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/latestos/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/latestos/releases"
